...
type InlineResponse2001Result struct {
	// Unique file Id that was generated for the disclosure response file uploaded.
	FileId string `json:"fileId"`
	// Provides the processing status of the files.
	FileProcessingStatus string `json:"fileProcessingStatus"`
	// Filename
	Filename string `json:"filename"`
	// Validation status of the disclosure response.
	ResponseStatus string `json:"responseStatus,omitempty"`
	// Description associated with file processing status.
