...
// Postal address of the party. Note: Information that locates and identifies a specific address, as defined by postal services.
type PostalAddress1 struct {
	// Identifies the nature of the postal address.  Valid code(s)\\:  1) 'ADDR': Address is the complete postal address. 2) 'PBOX': Address is a postal office (PO) box. 3) 'HOME': Address is the home address. 4) 'BIZZ': Address is the business address. 5) 'MLTO': Address is the address to which mail is sent. 6) 'DLVY': Address is the address to which delivery is to take place.
	...
	Country *AllOfPostalAddress1Country `json:"country"`
}
