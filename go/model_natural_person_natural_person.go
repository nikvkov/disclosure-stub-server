...
type NaturalPersonNaturalPerson struct {
	NameAndAddress *NaturalPersonNameAndAddress `json:"nameAndAddress"`

	EmailAddress *AllOfNaturalPersonNaturalPersonEmailAddress `json:"emailAddress,omitempty"`

	Identification *NaturalPersonIdentification `json:"identification"`

	Nationality *AllOfNaturalPersonNaturalPersonNationality `json:"nationality,omitempty"`

	DateAndPlaceOfBirth *NaturalPersonDateAndPlaceOfBirth `json:"dateAndPlaceOfBirth,omitempty"`
