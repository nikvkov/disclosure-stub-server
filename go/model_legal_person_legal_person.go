...
// Legal entity.
type LegalPersonLegalPerson struct {
	NameAndAddress *NameAndAddress2 `json:"nameAndAddress"`

	EmailAddress *AllOfLegalPersonLegalPersonEmailAddress `json:"emailAddress,omitempty"`
	// Identification of the party.
	Identification *OneOfLegalPersonLegalPersonIdentification `json:"identification"`

	CountryOfIncorporation *AllOfLegalPersonLegalPersonCountryOfIncorporation `json:"countryOfIncorporation,omitempty"`
	// Year in which the legal entity has been incorporated.
	YearOfIncorporation string `json:"yearOfIncorporation,omitempty"`
	// Economical activity of the investor according to the ISIC standard.  Additional details\\: Identifier of economic activities by ISIC (United Nations' International Standard Industrial Classification of all Economic Activities).
	ActivityIndicator string `json:"activityIndicator,omitempty"`

	InvestorType *InvestorType `json:"investorType,omitempty"`
