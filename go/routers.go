...
var routes = Routes{
	...
	Route{
		"FileProcessingStatusPost",
		strings.ToUpper("Post"),
		"/sdh_api/fileProcessingStatus",
		FileProcessingStatusPost,
	},
	...
	Route{
		"FileUploadTokenPost",
		strings.ToUpper("Post"),
		"/sdh_api/fileUploadToken",
		FileUploadTokenPost,
	},

	Route{
		"UploadDisclosureResponsePost",
		strings.ToUpper("Post"),
		"/sdh_api/uploadDisclosureResponse",
		UploadDisclosureResponsePost,
	},

	Route{
		"DisclosureRequestsPost",
		strings.ToUpper("Post"),
		"/sdh_api/disclosureRequests",
		DisclosureRequestsPost,
	},
